...
mongoDB=pymongo.MongoClient('mongodb+srv://Ajhay:ram1234@salespredict.cd5fmto.mongodb.net/?retryWrites=true&w=majority')
db=mongoDB['SalesPrediction']
account=db.account

app=Flask(__name__)
app.secret_key=b'\x08\x90Tj\x07\xa8l\x84\x9d\xf3\xd58\xac\xb0Q\x97:\xb9\x9a\xc0#\xabi\x06'
CORS(app)    
...
def postPrediction(email):
    ...
    if request.method=="POST":
        ...
        prediction =frame.to_csv('../src/assets/file/prediction.csv',index=False)
        dfd = pd.read_csv('../src/assets/file/prediction.csv')
