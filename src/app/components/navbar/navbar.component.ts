...
export class NavbarComponent implements OnInit {
  ...
  phoneNumber: any;
  @ViewChild('aboutLink')
  siblingAboutNavLink!: ElementRef;
  @ViewChild('predictDatasetLink')
  siblingPredictDatasetNavLink!: ElementRef;
  @ViewChild('samplesLink')
  siblingSamplesLink!: ElementRef;
  @ViewChild('contactUsLink')
  siblingContactUsLink!: ElementRef;
  @ViewChild('savedPredictionsLink')
  siblingSavedPredictionsLink!: ElementRef;
  @ViewChild('navbarcontainer')
  siblingNavbarContainerElement!: ElementRef;
  @ViewChild('navbrand')
  siblingNavBrandLink!: ElementRef;
  @ViewChild('loginlink')
  siblingLoginLink!: ElementRef;
  @ViewChild('home')
  siblingHomeLink!: ElementRef;
  @ViewChild('features')
  siblingFeatureLink!: ElementRef;
  @ViewChild('moreInfoLink')
  siblingMoreInfoLink!: ElementRef;
